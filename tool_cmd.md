eful shell statistic function: x sf adf scf
...
// this example was translate in awk form.
...
* You see, the code is very short, compare against the awk form.
...
* 
* #### It's a little noisy, we just want the first name and country, use: sf $file1 $file2 1 3 '1 3' '2 1'
* 
* result is:
* 
* Louix China
